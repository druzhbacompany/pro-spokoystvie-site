...
export const metadata: Metadata = {
  ...
  description:
    "Услуги клиники «ПРО спокойствие» по утверждённому прайсу: приёмы психиатра, психолога, невролога и терапевта, психотерапия, лечебные блокады, ботулинотерапия, IV-терапия. Приём с соблюдением врачебной тайны.",
};

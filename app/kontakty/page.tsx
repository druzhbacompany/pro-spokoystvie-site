...
const FAQ = [
  ...
  // 2026-08-07 (чистка формулировок): безусловное «конфиденциально, без постановки
  // на учёт» заменено на корректную формулировку про врачебную тайну и закон.
  { q: "Как вы обращаетесь с информацией о визите?", a: "Мы работаем с соблюдением врачебной тайны: сведения об обращении не передаются третьим лицам, кроме случаев, прямо предусмотренных законом. Порядок обработки персональных данных описан в Политике конфиденциальности." },
];

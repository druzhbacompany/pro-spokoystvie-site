...
export const metadata: Metadata = {
  ...
  description:
    "Медицинский центр «ПРО спокойствие»: психиатрия, психотерапия, психология и неврология. Лицензия Минздрава, единый стандарт помощи, приём с соблюдением врачебной тайны.",
};
          ...
          <div className="smt-container grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="smt-lead mt-4 smt-muted">
                «ПРО спокойствие» — медицинский центр в Екатеринбурге. Психиатр, психотерапевт, психолог и невролог работают вместе под единым стандартом помощи: спокойно, бережно и с соблюдением врачебной тайны.
              </p>
              {/* 2026-08-07 (чистка формулировок): чипы «Без постановки на учёт»
                  и «Конфиденциально» заменены — безусловные обещания заменены на
          ...
          <div className="smt-container">
            ...
            <ul className="mt-6 grid gap-4 sm:grid-cols-2">
              {[
                ...
                "Приём с соблюдением врачебной тайны",

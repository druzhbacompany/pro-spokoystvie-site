    ...
    <footer className="smt-footer">
      <div className="smt-container smt-footer-cols">
        <div>
          ...
          {/* 2026-08-05 (P1-аудит главной): подвал виден на «/», поэтому из него убраны
              безусловное «конфиденциально» и обещание «без постановки на учёт».
              Подвал общий — формулировка меняется на всех страницах сайта. */}
          <p className="smt-footer-text">
            Психиатрия, психотерапия, психология и неврология в Екатеринбурге. Спокойно и деликатно, с соблюдением врачебной тайны.
          </p>
